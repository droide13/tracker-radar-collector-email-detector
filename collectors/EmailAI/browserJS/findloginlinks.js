(function () {
    const pattern = __LOGIN_REGEX_SRC__;
    const loginRegex = new RegExp(pattern, 'i');
    ...
    return allElements
        .filter(
            (el) =>
                ...
                (el.href &&
                    (el.href instanceof SVGAnimatedString ? el.href.baseVal.match(loginRegex) : String(el.href).match(loginRegex))) ||
